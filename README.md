...
oc new-app --as-deployment-config  docker.io/php:7.3.26-stretch~https://github.com/RedHatTraining/DO180-apps  --context-dir php-helloworld --name php-helloworld --strategy=docker
```
